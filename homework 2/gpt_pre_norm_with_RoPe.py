...
class Encoder(nn.Module):
    def __init__(self, max_context_length, d_model, num_heads, d_head, base=10000.0, dropout=0.1, epsilon=1e-6):
        super().__init__()
        self.max_context_length = max_context_length
...
class GPTPreNormWithRoPe(nn.Module):
    def __init__(self, max_context_length, num_encoder_blocks, vocab_size, d_model, num_heads, base=10000.0, dropout=0.1):
        super().__init__()
        self.max_context_length = max_context_length
